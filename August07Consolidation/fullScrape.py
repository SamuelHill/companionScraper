...
from academic_groups import *
from CourseResolver import *
...
def main():
	########
	print('academic_groups')
	academic_groups = AcademicGroupResolver().pull()
	toFile(academic_groups, 'academic_groups')
	########
	print('courses')
	courses = CourseResolver().resolve().ontologize()
	toFile(courses, 'courses')
	########
	print('colleges')
